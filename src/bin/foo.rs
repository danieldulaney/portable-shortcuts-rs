static TARGET: &'static str = "a:\\tools\\foo\\bin\\foo.exe";
static PATHS: &'static [&str] = &["a:\\path1", "a:\\path2"];
static ENV_VARS: &'static [&str] = &["ABS_PATH_ENV", "ANOTHER_ENV", "MY_ENV"];
static ENV_VALS: &'static [&str] = &["a:\\abs path", "another env value", "my env value"];
